...
public class GitHubAuthController {
    ...
    public ResponseEntity<Map<String, Object>> exchangeCodeForToken(@RequestBody String code) {
        ...
        if (response.getStatusCode() == HttpStatus.OK && response.getBody() != null) {
            ...
            log.error("Error al intercambiar el código por el token: {} - {}", response.getStatusCode(), response.getBody());
    ...
    private String getUserEmail(String accessToken) {
        ...
        if (response.getStatusCode() == HttpStatus.OK && response.getBody() != null) {
            ...
            log.error("Error al obtener el email del usuario: {} - {}", response.getStatusCode(), response.getBody());
        }
        return null;
    }
}